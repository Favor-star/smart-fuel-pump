    ...
    <SafeAreaView className="h-screen px-3 pt-1 w-full bg-background">
      <ScrollView className="w-full">
        <View className="w-full">
          <Text className="text-2xl font-pSemiBold">Refill your tank</Text>
          <Text className="text-sm font-pRegular">
            Be able to buy a fuel using this following input
          </Text>
        </View>
        <View className=" w-full ">
          <Text className="text-lg font-semibold mt-3 font-pRegular">
            Choose:
          </Text>
          ...
          <View className="w-full bg-background ">
            <Text className="text-base font-pSemiBold mt-3">
              Pricing Information:
            </Text>
            <View className="w-full p-4 bg-white rounded-xl  h-fit items-center justify-center">
              {!isUsingL && (
                <View className="w-full justify-between flex-row mb-2">
                  <Text className="font-pRegular">Amount entered</Text>
                  <Text className="font-pSemiBold">{priceInfo.amount} RWF</Text>
                </View>
              )}
              {isUsingL && (
                <View className="w-full justify-between flex-row mb-2">
